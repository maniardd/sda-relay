...
def deploy_phase1(form_data: dict) -> Dict[str, Any]:
    ...
    # Augment schema verified 2026-05-04 against IOS-XE 17.18 device GET.
    step_order = [
        ...
        ("p2p_augment_border", "Border P2P ISIS+PIM augment"),
        ("p2p_augment_edge", "Edge P2P ISIS+PIM augment"),
